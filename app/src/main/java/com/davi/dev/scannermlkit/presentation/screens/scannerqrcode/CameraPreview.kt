...
import com.davi.dev.scannermlkit.domain.qrcode.BarcodeAnalizer
import com.davi.dev.scannermlkit.presentation.screens.viewModel.ScannerQrCodeViewModel

@Composable
fun CameraPreview(viewModel: ScannerQrCodeViewModel) {
    ...
    AndroidView(
        ...
        update = { previewView ->
            ...
            cameraProviderFuture.addListener({
                ...
                val barcodeAnalyzer = BarcodeAnalizer(viewModel)
